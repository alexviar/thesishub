<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1.75em" width="1.75em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="ms-auto">
                <form action="{{route('trabajos_grado.buscar')}}" class="d-flex" style="min-width:500px">
            ...
            <ul class="navbar-nav ms-2 mb-2 mb-lg-0">
                @if(Auth::user())
                <li class="nav-item">
                    <a class="nav-link" href="{{route('trabajos_grado.publicar')}}">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{url('/usuarios')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
